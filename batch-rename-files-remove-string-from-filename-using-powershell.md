<!--{ Title:"Batch Rename Files to Remove a String From The File Name", PublishedOn:"Dec 6 2012", Intro:"I recently scripted out stored procs to a file. SSMS nicely included "StoredProcedure" in the file name. Here's how to remove a substring in many files in a directory with one line of PowerShell."} -->
