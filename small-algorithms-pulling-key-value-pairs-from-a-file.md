<!--{Title:"Small Algorithms: Pulling Key Value Pairs From A File",PublishedOn:"Feb 7 2014",Intro:"I recently had the chance to create a small algorithm to extract key-value pairs from a flat file."}-->
