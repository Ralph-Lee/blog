...
The whole rumour within the development community/blogs about "LINQ To SQL is being unsupported, Entity Framework is the new coolness" was just plain wrong, I believe. Microsoft is too big, and has too many projects on the go. They'll gauge the momentum of both technologies. Have you heard <a href="http://herdingcode.com/?p=187">Damien as a guest on Herding Code Episode 50</a>? In this blog post, Damien says that the focus for Microsoft will be on EF, and that's fine. L2S is definitely not dead!
...
**- Here's a small defect. I've not needed to search for tildes very much, but I decided to give it a shot just in case! It's true, the behavior is just as described! 

<img  src="img/tilde2.png" width="271" height="111" />

 
<img   src="img/tilde_thumb.png" width="653" height="170" />
...
<img   src="img/DeleteDatabase.png" width="434" height="107" />
...
<img  src="img/varchar.png" width="352" height="204" />
<img   src="img/lenzero.png" width="810" height="188" />
...
<img   src="img/computed.png" width="301" height="332" />
<img   src="img/decimalsOK.png" width="670" height="233" />
...
<img   src="img/decimalzero_thumb.png" width="415" height="484" />
...
<img   src="img/modifydbml_thumb.png" width="860" height="125" />
</a>
