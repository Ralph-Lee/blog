<!--{Title:"More Readable Code With Extension Methods",Intro:"Fewer complicated condition checks. Useful if you have lots of OR checks on the same item in a condition.",PublishedOn:"25-Jun-2014"}-->
